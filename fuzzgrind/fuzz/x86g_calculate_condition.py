...
def sub(size, cond, cc_dep1, cc_dep2):
    if cond == 'X86CondZ':
        ...
        if  size == 8: return '1Uto32(CmpLE32S(8Sto32(%s),8Sto32(%s)))' % (cc_dep1, cc_dep2)
        elif   size == 32: return '1Uto32(CmpLE32S(%s,%s))' % (cc_dep1, cc_dep2)
    elif cond == 'X86CondL':
        if  size == 8: return '1Uto32(CmpLT32S(8Sto32(%s),8Sto32(%s)))' % (cc_dep1, cc_dep2)
        elif   size == 32: return '1Uto32(CmpLT32S(%s,%s))' % (cc_dep1, cc_dep2)
    elif cond == 'X86CondB':
